...
const RAZORBACK_VERSION = readRazorbackVersion();
...
function brandMarkup() {
  const version = escapeHtmlText(RAZORBACK_VERSION);
  return '<div class="brand"><a href="https://github.com/anortham/razorback"><span class="brand-copy">Razorback v' + version + '</span></a></div>';
}
