...
Use these checks when Gate Mode finds structural relevance or when Candidate Mode is requested. The point is not to decorate the plan. The point is to decide whether a structural change is real, useful, and local enough to justify itself.
